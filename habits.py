...
#         habits_listbox.insert(tk.END, "Habit: " + habits_list[i] + ", Time: " + convert_time(time_list[i]))
#
#
# def get_daily_quote():
...
#     """Is passed a ctime string, will return the difference between then and the current date."""
#
#
# root = tk.Tk()
...
def add_new_habit(habit):
    ...
    if habit == "":
        ...
        habits_listbox.insert(tk.END, "Habit: " + habit + ", Time: " + str(datetime.datetime.now().replace(microsecond=0)))
        habits_list.append(habit)
